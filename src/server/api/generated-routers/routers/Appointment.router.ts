...
export default function createRouter() {
    return createTRPCRouter({
        ...
        aggregate: procedure.input($Schema.AppointmentInputSchema.aggregate).query(({ ctx, input }) => checkRead(db(ctx).appointment.aggregate(input as any))),
        ...
        findFirstOrThrow: procedure.input($Schema.AppointmentInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).appointment.findFirstOrThrow(input as any))),
        ...
        findUniqueOrThrow: procedure.input($Schema.AppointmentInputSchema.findUnique).query(({ ctx, input }) => checkRead(db(ctx).appointment.findUniqueOrThrow(input as any))),

        groupBy: procedure.input($Schema.AppointmentInputSchema.groupBy).query(({ ctx, input }) => checkRead(db(ctx).appointment.groupBy(input as any))),
        ...
        upsert: procedure.input($Schema.AppointmentInputSchema.upsert).mutation(async ({ ctx, input }) => checkMutate(db(ctx).appointment.upsert(input as any))),
