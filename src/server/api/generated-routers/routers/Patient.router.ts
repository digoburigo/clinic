...
export default function createRouter() {
    return createTRPCRouter({
        ...
        aggregate: procedure.input($Schema.PatientInputSchema.aggregate).query(({ ctx, input }) => checkRead(db(ctx).patient.aggregate(input as any))),
        ...
        findFirstOrThrow: procedure.input($Schema.PatientInputSchema.findFirst.optional()).query(({ ctx, input }) => checkRead(db(ctx).patient.findFirstOrThrow(input as any))),
        ...
        findUniqueOrThrow: procedure.input($Schema.PatientInputSchema.findUnique).query(({ ctx, input }) => checkRead(db(ctx).patient.findUniqueOrThrow(input as any))),

        groupBy: procedure.input($Schema.PatientInputSchema.groupBy).query(({ ctx, input }) => checkRead(db(ctx).patient.groupBy(input as any))),
        ...
        upsert: procedure.input($Schema.PatientInputSchema.upsert).mutation(async ({ ctx, input }) => checkMutate(db(ctx).patient.upsert(input as any))),
