...
export function InvitationError({ hasUser }: { hasUser: boolean }) {
  const href = hasUser ? `/patient-area` : `/register?iup=true`;
      ...
      <CardContent>
        {hasUser && (
          <P className="mb-4 text-sm">
            O registro que você está tentando acessar é inválido ou você não tem
        ...
        {!hasUser && (
          <P className="mb-4 text-sm">
            ...
            vefique novamente o email do registro de paciente enviado para
