...
export function SocialInfoForm() {
  const { control } = useFormContext<SocialInfoForm>();
      ...
      <FormField
        ...
        render={({ field, fieldState }) => (
          <FormItem>
            ...
            <FormControl>
              <Input
                placeholder="Ex.: Enfermeiro, Professor, etc."
                {...field}
              />
            </FormControl>
            {fieldState.error && (
      ...
      <FormField
        ...
        render={({ field, fieldState }) => (
          <FormItem>
            ...
            <FormControl>
              <Input
                placeholder="Ex.: Heterossexual, Homossexual, etc."
                {...field}
              />
            </FormControl>
            {fieldState.error && (
