...
import { SolarSidebarMinimalisticBoldDuotone } from "~/components/svgs/solar-sidebar-minimalistic-bold-duotone";
...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      {...props}
    >
      <SolarSidebarMinimalisticBoldDuotone className="text-muted-foreground size-5 rotate-180" />
