  ...
  return (
    <>
      {React.Children.map(childArr[activeStep], (node) => {
        ...
        const n: React.ReactElement = node as React.ReactElement;
        return React.Children.map(
          (n.props as unknown as { children: React.ReactNode }).children,
          (childNode) => childNode,
        );
      })}
    </>
    ...
    return (
      <div
        ...
        className={cn(
          ...
          "not-last:flex-1",
          "not-last:after:transition-all not-last:after:duration-200",
          "not-last:after:content-[''] not-last:after:h-[2px] not-last:after:bg-border",
          "data-[completed=true]:not-last:after:bg-primary",
          "data-[invalid=true]:not-last:after:bg-destructive",
          variant === "circle-alt" &&
          ...
          variant === "circle" &&
            "not-last:after:flex-1 not-last:after:ms-(--step-gap) not-last:after:me-(--step-gap)",
          variant === "line" &&
